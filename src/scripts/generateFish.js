...
function getFishStats(name) {
	const stats = {
		...
		'Tuna': { minSize: 100, maxSize: 200, minWeight: 30, maxWeight: 100, baseValue: 75 },
		...
		'Kraken': { minSize: 500, maxSize: 1000, minWeight: 500, maxWeight: 1000, baseValue: 200 },
		'Anglerfish': { minSize: 20, maxSize: 40, minWeight: 1, maxWeight: 3, baseValue: 500 },
		...
		'Salmon': { minSize: 50, maxSize: 100, minWeight: 3, maxWeight: 10, baseValue: 200 },
		...
		'Ogopogo': { minSize: 500, maxSize: 1000, minWeight: 500, maxWeight: 1000, baseValue: 100 },
		'Golden Pike': { minSize: 50, maxSize: 100, minWeight: 5, maxWeight: 20, baseValue: 600 },
		...
		'Koi': { minSize: 30, maxSize: 60, minWeight: 2, maxWeight: 5, baseValue: 20 },
